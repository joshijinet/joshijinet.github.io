...
birthChartAnalysisContent=
  "We analyzes a birth chart (also known as a Kundali or horoscope) to gain insights into an individual's life path, personality, strengths, weaknesses, and potential challenges. Here's what they typically do in a birth chart analysis:<br />   
  <b>Chart Calculation:</b><br />
  We use individual's birth date, time, and place to calculate the precise positions of the planets and other celestial bodies at the time of their birth. This information is used to create the birth chart, which is a visual representation of the celestial positions.<br />   
  ...
  <b>Predictions and Guidance:</b><br />
  Based on the chart analysis, the Jyotish can make predictions about various aspects of the individual's life, such as: Career and finances, Relationships and marriage, Health and well-being, Education and spiritual growth. <br /><br />
